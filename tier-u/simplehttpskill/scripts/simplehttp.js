/**
 * Simple HTTP Skill — Whistant JSC (JavaScriptCore) adapter
 * Uses fetch() instead of Node.js http/https — no external deps
 * Body is always string/object (no Buffer in JSC)
 */
...
// Export for Whistant JSC's require()
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { SimpleHttpClient: SimpleHttpClient };
}
