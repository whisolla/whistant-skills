---
name: discord
description: Send and read Discord messages via Discord REST API v10 using a Bot Token. Supports send, read, react, edit, delete, threads, DMs, guild discovery, and more — all via fetch().
version: 3.6
---
# discord
