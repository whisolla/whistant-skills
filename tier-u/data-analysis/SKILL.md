...
_Converted from ClawHub: `ivangdavila/data-analysis`_

## Runtime Compatibility

- fetch(), fs, crypto, http, https, path, buffer, querystring: ✅
- pkg add via jsDelivr CDN: ✅
- child_process, WebSocket, Blob, Worker threads: ❌
