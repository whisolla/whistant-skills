...
description: Transform AI agents from task-followers into proactive partners with memory architecture, reverse prompting, and self-he
version: 1.0
---
# proactive-agent-lite
_ClawHub: `bestrocky/proactive-agent-lite`_
## Runtime: fetch✅ fs✅ | blocked: child_process WebSocket Blob
# Proactive Agent Lite
