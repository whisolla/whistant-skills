...
description: Transform your agent from reactive to proactive. Set up a proactive heartbeat, continuous operation patterns, token budget awareness, and handoff notes so the agent works between prompts.
version: 1.3
---
# agent-autonomy-kit 🚀
